...
export default function CommissionSettings() {
  ...
  const handleSave = async () => {
    try {
      ...
      const data = { ...DEFAULTS, ...(res.data || {}) };
      setSettings(data); setOriginal(data);
      setSuccess("Commission settings updated ");
  ...
  return (
    <div className="max-w-[1500px]">
      ...
      <div className="mb-5">
        ...
        <p className="text-[13px] text-brand-muted ml-3 mt-1">Control platform fees, penalties, and payment windows</p>
      </div>
      ...
      <div className="bg-white border border-brand-border rounded-[20px] p-5 md:p-6">
        ...
        <Row
          ...
          hint="Charged to the buyer on every order as the platform's profit. This amount is not paid to the supplier."
        >
        ...
        <Row
          label="Delivery Fee"
          hint="Charged to the buyer on every order to cover rider and delivery costs."
        >
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-brand-lighter rounded-[10px] mb-2 mt-1">
          <p className="text-[13px] text-brand-gray m-0">Total added to the buyer(Commission + Delivery)</p>
        ...
        <Row
          label="Supplier Order Return Penalty"
          hint="When a return order occurs due to the supplier's fault, this percentage is deducted from the supplier's invoice."
        >
        ...
        <Row
          ...
          hint="The number of days the buyer has to make the payment after receiving the invoice."
        >
        ...
        <Row
          ...
          hint="he number of days the admin has to release payment to the supplier after receiving the buyer's payment."
        >
